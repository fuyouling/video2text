...
视频转文本工具 - 使用 faster-whisper 进行语音转写，默认使用 Ollama 或 NVIDIA API 进行文本总结，语音转写和文本总结模型可自行更换。

## GUI

![](https://github.com/user-attachments/assets/bd10bfc4-9234-4672-84e9-e4fe3c6cfdb2)
