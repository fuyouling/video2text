...
_KEY_LABELS: dict[str, str] = {
    ...
    "transcription.initial_prompt": "初始提示词",
    "transcription.hotwords": "热词",
...
_KEY_TOOLTIPS: dict[str, str] = {
    ...
    "transcription.initial_prompt": "一段自然语言提示，可填领域词汇/专有名词以提升识别准确率，留空不启用",
    "transcription.hotwords": "热词偏置，多个词用空格分隔；prefix 非空时无效，留空不启用",
